...
// [	return 0;]
// [}]
// 요구하는 함수와 원형을 작성하여 이 뼈대를 완성하라. 디폴트 매개변수를 사용하는 두 개의 show() 함수를 사용해야 한다. 필요하면 const 매개변수를 사용하라.
// set()은 new를 사용하여 주어진 문자열을 저장할 수 있을 만큼 충분한 공간을 대입해야 한다. 여기서 사용하는 기법은 클래스를 설계하고 구현할 때 사용하는 것과 비슷하다. (사용하는 컴파일러가 헤더 파일 이름을 변경하고, using 지시자의 삭제를 요구할 수도 있다.)
