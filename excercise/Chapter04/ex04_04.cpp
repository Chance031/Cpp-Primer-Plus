// Q. 퍼스트 네임(이름)과 라스트 네임(성)을 사용자에게 입력하도록 요청하고, 라스트 네임, 콤마, 빈칸, 퍼스트 네임으로 이루어지는 제3의 문자열을 구성하고, 저장하고, 출력하는 프로그램을 작성하라.
// string 객체와 string 헤더 파일이 제공하는 메서드를 사용하라. 실행 예는 다음과 같아야 한다.
