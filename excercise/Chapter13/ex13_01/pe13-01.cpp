...
// [};]
//
// 그 CD의 대표곡을 나타내는 문자열을 저장하기 위한 char형의 배열을 하나 추가시켜, Classic 클래스를 파생시켜라. 기초 클래스의 어떤 함수가 가상일 것을 요구한다면, 그렇게 되도록 기초 클래스를 수정하라. 
// 불필요한 메서드가 선언되어 있다면 찾아서 제거하라. 다음과 같은 프로그램을 사용하여 사용자가 작성한 코드들이 바르게 동작하는지 테스트하라. (classic.h, classic.cpp, pe13-01.cpp)
//
