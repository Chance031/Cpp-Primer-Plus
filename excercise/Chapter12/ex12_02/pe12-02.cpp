// Q. 다음과 같은 요구대로 String 클래스 선언을 개선하라. (즉, string1.h를 string2.h로 업그레이드하라.)
// 
...
// d. char형의 매개변수를 사용하여, 그 문자열에 주어지는 문자가 출현하는 횟수를 리턴하는 멤버 함수를 제공하라.
// 다음과 같은 프로그램을 사용하여 자신의 업그레이드 결과를 테스트하라. (string2.h, string2.cpp, pe12-02.cpp)
// pe12-02.cpp -- 12장 프로그래밍 연습
// [#include <iostream>]
// [using namespace std;]
// [#include "string2.h"]
// [int main()]
...
int main()
{
	...
	std::cout << "빛의 삼원색의 이름을 하나만 입력하십시오: ";
